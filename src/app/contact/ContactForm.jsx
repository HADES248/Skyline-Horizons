  ...
  return (
    ...
    <form className="mb-4 w-full max-w-sm 2xl:mx-auto" onSubmit={handleSubmit}>
      ...
      <div className="mb-4">
        ...
        <textarea id="message" rows="4" className="block p-2.5 w-full text-sm rounded-lg border bg-gray-900 border-gray-700 placeholder-gray-500 text-gray-200 focus:ring-blue-500 focus:border-blue-500" placeholder="Your message..." required onChange={(e) => setMessage(e.target.value)} value={message} />
      </div>
