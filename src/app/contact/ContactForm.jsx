  ...
  return (
    ...
    <form className="mb-4 w-full max-w-sm 2xl:mx-auto" onSubmit={handleSubmit}>
      ...
      <div className="flex justify-center items-center">
        <button type="submit" className="w-1/2 text-white hover:text-gray-800 bg-primary hover:bg-white font-medium rounded-lg text-sm px-5 py-2.5 cursor-pointer">Send message</button>
      </div>
    </form>
  )
}
