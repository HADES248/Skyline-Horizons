  ...
  return (
    <div>
      <div className="container flex flex-col sm:flex-row items-center justify-between overflow-x-hidden">
        ...
        />
        <div className="md:w-[40%] flex justify-center items-center mt-3 flex-col ml-4 md:ml-6 pr-6 mr-6 p-6 bg-gradient-to-r from-gray-800 via-gray-700 to bg-gray-800 border-gray-700 rounded-xl shadow-lg">
