...
export default function LogIn() {
  return (
    <div>
      <div className="max-w-screen-2xl flex flex-col sm:flex-row items-center justify-between 2xl:mx-auto">
        <img src="sign-in.jpg" className="h-[565px] hidden sm:block sm:w-[400px] lg:w-[600px] xl:w-[850px] object-cover"/>
        <div className="md:w-1/2 max-w-lg flex justify-center items-center mt-3 flex-col ml-4 md:ml-6 pr-6 mr-6 p-6 bg-gradient-to-r from-gray-800 via-gray-700 to bg-gray-800 border-gray-700 rounded-xl shadow-lg">
          ...
          <Link href='/signup' className="hover:text-primary mt-2">Go to Sign Up page?</Link>
        </div>
      </div>
    </div>
  )
